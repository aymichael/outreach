  ...
  return (
    <div className="m-4 h-full">
      ...
      <p className="text-base md:text-lg my-4">
        Since 2019, <b>The TUYF Charitable Trust</b> graciously supported the <b>Department of Mathematics, CUHK</b> to implement the CUHK - HKTLC collaboration project. In this pilot project, workshops, popular science talks and other events were organized for the students at Hong Kong True Light College to develop their comprehensive understanding and deep appreciation of mathematics. To promote collaborative learning and STEM education, students from Hong Kong True Light College, Kowloon True Light School, True Light Girls&apos; College and True Light Middle School of Hong Kong are invited to join a mathematics day camp organized by the Department. It was a whole-day activity which provided an introduction to Boolean algebra and its practical applications through engaging group activities. Building upon years of extensive experience in organizing outreach activities and the successful collaboration with HKTLC over the past three years, the Department decided to implement the collaboration project on a community-wide scale.
      </p>
      <p className="text-base md:text-lg my-4">
